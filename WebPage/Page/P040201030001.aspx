<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P040201030001.aspx.cs" Inherits="Page_P040201030001" %>
            ...
            <ContentTemplate>
                <table width="100%" border="0" cellpadding="0" cellspacing="1">
                    <tr class="itemTitle">
                        <td colspan="2">
                            <li>
                                <cc1:CustLabel ID="lblTitle" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2" IsColon="False" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_02010300_001" StickHeight="False"></cc1:CustLabel></li>
                        </td>
                    </tr>
                    <tr class="trOdd">
                        <td align="right" style="width: 20%">
                            <cc1:CustLabel ID="lblID" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_02010300_002" StickHeight="False"></cc1:CustLabel></td>
                        <td style="width: 80%">
                    ...
                    <tr class="trEven">
                        <td style="text-align: right; width: 15%; height: 25px;">
                            <cc1:CustLabel ID="lblType" runat="server" FractionalDigit="2" IsColon="True" IsCurrency="False"
                                ...
                                StickHeight="False" ShowID="04_02010300_003" CurAlign="left" CurSymbol="&#163;"></cc1:CustLabel>
                        </td>
                        <td style="width: 85%">
                    ...
                    <tr align="center" class="itemTitle">
                        <td colspan="2">
                            <cc1:CustButton ID="btnSearch" runat="server" class="smallButton" Style="width: 50px;"  ShowID="04_02010300_012" OnClick="btnSearch_Click"/>&nbsp;&nbsp;
