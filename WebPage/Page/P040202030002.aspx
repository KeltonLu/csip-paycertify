<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P040202030002.aspx.cs" Inherits="Page_P040202030002" %>
            ...
            <ContentTemplate>
                <table cellpadding="0" cellspacing="1" width="100%" >
                    <tr class="itemTitle" >
		                <td colspan="4">
		                    <li>
                                <cc1:CustLabel ID="lblTitle" runat="server" CurAlign="left" CurSymbol="&#163;" FractionalDigit="2" IsColon="False" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_02020300_001" StickHeight="False"></cc1:CustLabel></li>
		                </td>
	                </tr>
	                <tr class="trOdd">
                        <td style="text-align: right;width:15%; height: 25px;">
                            <cc1:CustLabel ID="lblUserID" runat="server" CurAlign="left" FractionalDigit="2" IsColon="True" 
                             ...
                             NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_02020300_002"
                        ...
                        <td style="text-align: right;width:15%; height: 25px;">
                            <cc1:CustLabel ID="lblUserName" runat="server" CurAlign="left" FractionalDigit="2" IsColon="True" 
                             IsCurrency="False" NeedDateFormat="False"
                             NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_02020300_007"
                             StickHeight="False" CurSymbol="&#163;"></cc1:CustLabel>                    
                        </td>
                        <td style="text-align: left;width:35%; height: 25px;">
                    ...
                    <tr class="trEven">
                        <td style="text-align: right;width:15%; height: 25px;">
                            <cc1:CustLabel ID="lblZip" runat="server" CurAlign="left" FractionalDigit="2" IsColon="True" 
                             IsCurrency="False" NeedDateFormat="False"
                             NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_02020300_020"
                             StickHeight="False" CurSymbol="&#163;"></cc1:CustLabel>                    
                        </td>
                    ...
                    <tr class="trOdd">
                        <td style="text-align: right;width:15%; height: 25px;">
                            <cc1:CustLabel ID="lblAdd1" runat="server" CurAlign="left" FractionalDigit="2" IsColon="True" 
                             IsCurrency="False" NeedDateFormat="False"
                             NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_02020300_021"
                             StickHeight="False" CurSymbol="&#163;"></cc1:CustLabel>                    
                        </td>
                    ...
                    <td style="text-align: right;width:15%; height: 25px;">
                        ...
                        IsCurrency="False" NeedDateFormat="False"
                        NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_02020300_022"
                        StickHeight="False" CurSymbol="&#163;"></cc1:CustLabel>                    
                    </td>
                    ...
                    <td style="text-align: right;width:15%; height: 25px;">
                        ...
                        IsCurrency="False" NeedDateFormat="False"
                        NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_02020300_023"
                        StickHeight="False" CurSymbol="&#163;"></cc1:CustLabel>                    
                    </td>
                    <td style="text-align: left;width:50%; height: 25px;" colspan="3">
                    ...
                    <tr class="trEven">
                        <td style="text-align: right;width:15%; height: 25px;">
                            <cc1:CustLabel ID="lblConsignee" runat="server" CurAlign="left" FractionalDigit="2" IsColon="True" 
                             IsCurrency="False" NeedDateFormat="False"
                             NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_02020300_024"
                            StickHeight="False" CurSymbol="&#163;"></cc1:CustLabel>                    
                        </td>
                        <td style="text-align: left;width:35%; height: 25px;" >
                        ...
                        <td style="text-align: right;width:15%; height: 25px;">
                            <cc1:CustLabel ID="lblMailDay" runat="server" CurAlign="left" FractionalDigit="2" IsColon="True" 
                             IsCurrency="False" NeedDateFormat="False"
                             NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_02020300_025"
                             StickHeight="False" CurSymbol="&#163;"></cc1:CustLabel>                    
                        </td>
                        <td style="text-align: left;width:35%; height: 25px;">
                    ...
                    <td style="text-align: right;width:15%; height: 25px;">
                        ...
                        IsCurrency="False" NeedDateFormat="False"
                        NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_02020300_026"
                        StickHeight="False" CurSymbol="&#163;"></cc1:CustLabel>                    
                    </td>
                    <td style="text-align: left;width:50%; height: 25px;" colspan="3">
                    ...
                    <td style="text-align: right;width:15%; height: 25px;">
                        ...
                        IsCurrency="False" NeedDateFormat="False"
                        NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_02020300_027"
                        StickHeight="False" CurSymbol="&#163;"></cc1:CustLabel>                    
                    </td>
                    <td style="text-align: left;width:50%; height: 25px;" colspan="3">
                     ...
                     <tr class="trOdd">
                        <td style="text-align: right;width:15%; height: 25px;">
                            <cc1:CustLabel ID="lblMakeUpDate" runat="server" CurAlign="left" FractionalDigit="2" IsColon="True" 
                             IsCurrency="False" NeedDateFormat="False"
                             NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_02020300_028"
                            StickHeight="False" CurSymbol="&#163;"></cc1:CustLabel>                    
                        </td>
                        <td style="text-align: left;width:35%; height: 25px;" >
                        ...
                        <td style="text-align: right;width:15%; height: 25px;">
                            <cc1:CustLabel ID="lblEndDate" runat="server" CurAlign="left" FractionalDigit="2" IsColon="True" 
                             IsCurrency="False" NeedDateFormat="False"
                             NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_02020300_029"
                             StickHeight="False" CurSymbol="&#163;"></cc1:CustLabel>                    
                        </td>
                        <td style="text-align: left;width:35%; height: 25px;">
                    ...
                    <tr class="trEven">
                         <td style="text-align: right;width:15%; height: 25px;">
                            <cc1:CustLabel ID="lblMailType" runat="server" CurAlign="left" FractionalDigit="2" IsColon="True" 
                             IsCurrency="False" NeedDateFormat="False"
                             NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_02020300_030"
                            StickHeight="False" CurSymbol="&#163;"></cc1:CustLabel>                    
                        </td>
                        <td style="width: 35%">
                    ...
                    <tr class="trOdd">
                        <td style="text-align: right;width:15%; height: 25px;">
                            <cc1:CustLabel ID="lblshowExtra" runat="server" CurAlign="left" FractionalDigit="2" IsColon="True" 
                             IsCurrency="False" NeedDateFormat="False"
                             NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_02020300_035"
                            StickHeight="False" CurSymbol="&#163;"></cc1:CustLabel>                    
                        </td>
                        <td style="text-align: left;width:35%; height: 25px;" >
                        ...
                        <td style="text-align: right;width:15%; height: 25px;">
                            <cc1:CustLabel ID="lblgetFee" runat="server" CurAlign="left" FractionalDigit="2" IsColon="True" 
                             IsCurrency="False" NeedDateFormat="False"
                             NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_02020300_009"
                             StickHeight="False" CurSymbol="&#163;"></cc1:CustLabel>                    
                        </td>
                        <td style="text-align: left;width:35%; height: 25px;">
                     ...
                     <tr class="trEven">
                        <td style="text-align: right;width:15%; height: 25px;">
                            <cc1:CustLabel ID="lblReturnDay" runat="server" CurAlign="left" FractionalDigit="2" IsColon="True" 
                             IsCurrency="False" NeedDateFormat="False"
                             NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_02020300_033"
                            StickHeight="False" CurSymbol="&#163;"></cc1:CustLabel>                    
                        </td>
                        <td style="text-align: left;width:35%; height: 25px;" >
                            <cc1:CustTextBox ID="txtReturnDay" runat="server" InputType="String" Enabled="False" EnableTheming="True"  ></cc1:CustTextBox>
                        </td>
                        <td style="text-align: right;width:15%; height: 25px;">
                            <cc1:CustLabel ID="lblReturnReason" runat="server" CurAlign="left" FractionalDigit="2" IsColon="True" 
                             IsCurrency="False" NeedDateFormat="False"
                             NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_02020300_034"
                             StickHeight="False" CurSymbol="&#163;"></cc1:CustLabel>                    
                        </td>
                        <td style="text-align: left;width:35%; height: 25px;">
                            <cc1:CustTextBox ID="txtReturnReason" runat="server" InputType="String" Enabled="False" EnableTheming="True"  ></cc1:CustTextBox>
                        </td>    
                    </tr>
                    <tr class="itemTitle" align="center" >
                    <td colspan="4">
                        <cc1:CustButton  ID="btnPrint" runat="server"  CssClass="smallButton" OnClick="btnPrint_Click" ShowID="04_02020300_036"  />&nbsp;&nbsp;
                        <cc1:CustButton  ID="btnBack" runat="server"  CssClass="smallButton" OnClick="btnBack_Click" ShowID="04_02020300_037"  /></td>
               </tr>
              <tr>
