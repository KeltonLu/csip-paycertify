...
public partial class Page_P040302030001 : PageBase
{
    /// Session變數集合
    ...
    {
        Page.Title = BaseHelper.GetShowText("04_03020300_000");
        if (!Page.IsPostBack)
        {
    ...
    protected void gvpbSetPayCertify_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (e.Row.Cells[5].Text.Trim() != "&nbsp;")
                e.Row.Cells[5].Text = Convert.ToDecimal(e.Row.Cells[5].Text.Trim()).ToString("N0");

            EntitySet_Pay_Certify eSet_Pay_Certify = esSet_Pay_Certify.GetEntity(e.Row.RowIndex);
            if (eSet_Pay_Certify.isMail == "N")
            {
                e.Row.Cells[7].Text = "";//* 平信
                e.Row.Cells[8].Text = "";//* 限時
                e.Row.Cells[9].Text = "";//* 掛號
                e.Row.Cells[10].Text = "";//* 限掛
                e.Row.Cells[11].Text = "V";//* 自取
            ...
            //* 地址
            e.Row.Cells[12].Text = eSet_Pay_Certify.zip.Trim() + eSet_Pay_Certify.add1.Trim() + 
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (BRReport.Report0302030002(strStartSerialNo, strEndSerialNo, strUserID, strMailDay, strCardNo, strMailDayHid, ref strMsgID, ref dstResult, "P"))
            {
            ...
            if (dstResult != null)
            {
                ...
                if (!BR_Excel_File.CreateExcelFile_Report0302030002(dstResult, strMailDay, ref strServerPathFile, ref strMsgID))
                {
                ...
                string strFileName = "ML結清證明開立登記表" + strYYYYMMDD + ".xls";
    ...
    private void BindGridView()
    {
        ...
        try
        {
            if (!BRSet_Pay_Certify.SearchResult_03020300(this.ViewState["StartSerialNo"].ToString(),
            ...
            //* 查詢成功
            jsBuilder.RegScript(this.Page, BaseHelper.ClientMsgShow("04_03020300_008"));
        }
        catch (Exception exp)
        {
            Logging.Log(exp, LogLayer.UI);
            jsBuilder.RegScript(this.Page, BaseHelper.ClientMsgShow("04_03020300_007"));
        }
    }
    /// <summary>
    /// 顯示窗體文字
    ...
    {
        //* 設置查詢結果GridView的列頭標題
        this.gvpbSetPayCertify.Columns[0].HeaderText = BaseHelper.GetShowText("04_03020300_009");
        this.gvpbSetPayCertify.Columns[1].HeaderText = BaseHelper.GetShowText("04_03020300_010");
        this.gvpbSetPayCertify.Columns[2].HeaderText = BaseHelper.GetShowText("04_03020300_011");
        this.gvpbSetPayCertify.Columns[3].HeaderText = BaseHelper.GetShowText("04_03020300_012");
        this.gvpbSetPayCertify.Columns[4].HeaderText = BaseHelper.GetShowText("04_03020300_013");
        this.gvpbSetPayCertify.Columns[5].HeaderText = BaseHelper.GetShowText("04_03020300_014");
        this.gvpbSetPayCertify.Columns[6].HeaderText = BaseHelper.GetShowText("04_03020300_015");
        this.gvpbSetPayCertify.Columns[7].HeaderText = BaseHelper.GetShowText("04_03020300_016");
        this.gvpbSetPayCertify.Columns[8].HeaderText = BaseHelper.GetShowText("04_03020300_017");
        this.gvpbSetPayCertify.Columns[9].HeaderText = BaseHelper.GetShowText("04_03020300_018");
        this.gvpbSetPayCertify.Columns[10].HeaderText = BaseHelper.GetShowText("04_03020300_019");
        this.gvpbSetPayCertify.Columns[11].HeaderText = BaseHelper.GetShowText("04_03020300_020");
        this.gvpbSetPayCertify.Columns[12].HeaderText = BaseHelper.GetShowText("04_03020300_021");
        this.gvpbSetPayCertify.Columns[13].HeaderText = BaseHelper.GetShowText("04_03020300_022");
        this.gvpbSetPayCertify.Columns[14].HeaderText = BaseHelper.GetShowText("04_03020300_023");
        //* 設置一頁顯示最大筆數
