<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P040301040002.aspx.cs" Inherits="Page_P040301040002" %>
            ...
            <ContentTemplate>
                <table width="100%" border="0" cellpadding="0" cellspacing="1">
                    <tr class="itemTitle">
                        <td colspan="4">
                            <li>
                                <cc1:CustLabel ID="lblTitle" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2" IsColon="False" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_03010400_001" StickHeight="False"></cc1:CustLabel></li>
                        </td>
                    </tr>
                    <tr class="trOdd">
                    ...
                    <tr class="trEven">
                          <td align="right" style="width: 20%">
                            <cc1:CustLabel ID="lblBackDate" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_03010400_026" StickHeight="False"></cc1:CustLabel></td>
                        <td  colspan="3">
                            <cc1:DatePicker ID="dtpBackDate" runat="server" MaxLength="10">
                            </cc1:DatePicker>
                            </td>
                    </tr>
                    <tr class="trOdd">
                        <td align="right" style="width: 20%">
                            <cc1:CustLabel ID="lblBackReason" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_03010400_027" StickHeight="False"></cc1:CustLabel></td>
                        <td  colspan="3">
