<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P040101040002.aspx.cs" Inherits="Page_P040101040002" %>
...
<asp:ScriptManager ID="ScriptManager1" EnablePageMethods="True" runat="server">
    ...
    <tr class="trOdd">
          ...
          <cc1:CustTextBox ID="txtSerialNo" runat="server"  Width="173px" Enabled="false"></cc1:CustTextBox></td>
    </tr>
   ...
   <tr class="trEven">
         <td style="text-align: right;width:25%">
          ...
          <td style="text-align: left;width:75%">
          <cc1:CustTextBox ID="txtUserID" runat="server"  Width="173px" Enabled="false"></cc1:CustTextBox></td>
   </tr>
   ...
   <tr class="trOdd">
        ...
        <td style="text-align: left;width:85%">
         <cc1:DatePicker ID = "dtpBackDate" runat="server" Width="173" ></cc1:DatePicker>
         </td>
  </tr>
 ...
 <tr class="trEven">
     <td style="text-align: right;width:25%">
       ...
       <td style="text-align: left;width:75%">
          <cc1:CustTextBox ID="txtCase" runat="server" MaxLength="50" Width="173px" TextMode="MultiLine" Height="70px" InputType="Memo"></cc1:CustTextBox></td>
