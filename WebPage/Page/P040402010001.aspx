<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P040402010001.aspx.cs" Inherits="Page_P040402010001" %>
            ...
            <ContentTemplate>
                <table width="1050" border="0" cellpadding="0" cellspacing="1">
                    <tr class="itemTitle">
                        <td colspan="2">
                            <li>
                                <cc1:CustLabel ID="lblTitle" runat="server" CurAlign="left" CurSymbol="&#163;" FractionalDigit="2" IsColon="False" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_04020100_001" StickHeight="False"></cc1:CustLabel></b></li>
                        </td>
                    </tr>
                    <tr class="trOdd">
                        <td align="right" style="width: 20%">
                            <cc1:CustLabel ID="lblCertifyNo" runat="server" CurAlign="left" CurSymbol="&#163;" FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_04020100_002" StickHeight="False"></cc1:CustLabel></td>
                        <td style="width: 80%">
                    ...
                    <tr class="trEven">
                        <td align="right" style="width: 20%">
                            <cc1:CustLabel ID="lblID_No" runat="server" CurAlign="left" CurSymbol="&#163;" FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_04020100_003" StickHeight="False"></cc1:CustLabel></td>
                        <td style="width: 80%">
                            <cc1:CustTextBox ID="txtID_No" Style="ime-mode: disabled; text-align: left" runat="server"
                                MaxLength="11"></cc1:CustTextBox>&nbsp;&nbsp;&nbsp;&nbsp;
                            <cc1:CustTextBox ID="txtID_Name" runat="server" Enabled="False"></cc1:CustTextBox></td>
                    </tr>
                    <tr class="trOdd">
                        <td align="right" style="width: 20%">
                            <cc1:CustLabel ID="lblSelfGetDate" runat="server" CurAlign="left" CurSymbol="&#163;" FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_04020100_004" StickHeight="False"></cc1:CustLabel></td>
                        <td style="width: 80%">
                    ...
                    <tr class="trEven">
                        <td align="right" style="width: 20%">
                            <cc1:CustLabel ID="lblCardNo" runat="server" CurAlign="left" CurSymbol="&#163;" FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_04020100_005" StickHeight="False"></cc1:CustLabel></td>
                        <td style="width: 80%">
                    ...
                    <tr align="center" class="itemTitle">
                        <td colspan="2">
                            <cc1:CustButton ID="btnSearch" runat="server" class="smallButton" Style="width: 50px;"
                                OnClick="btnSearch_Click" ShowID="04_04020100_006" />&nbsp;&nbsp;
                            <cc1:CustButton ID="btnClear" runat="server" class="smallButton" Style="width: 50px;" OnClick="btnClear_Click" ShowID="04_04020100_007" />
                        </td>
                    </tr>
                </table>
                        ...
                        <td colspan="2">
                            <cc1:CustGridView ID="gvpbSetPayCertify" runat="server" AllowSorting="True" PagerID="gpList"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="mailDay">
                                    ...
                                    <asp:BoundField DataField="voidDay">
                                        <itemstyle width="80" horizontalalign="Center" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="User_Name">
                                        <itemstyle width="80" horizontalalign="Center" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="Back_Date">
                                        <itemstyle width="80" horizontalalign="Center"/>
                                    </asp:BoundField>
                                    <asp:BoundField DataField="BackNote">
                                        <itemstyle width="100" horizontalalign="Center"/>
                                    </asp:BoundField>
                                </Columns>
                            </cc1:CustGridView>
