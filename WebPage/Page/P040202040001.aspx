<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P040202040001.aspx.cs" Inherits="Page_P040202040001" %>
            ...
            <table cellpadding="0" cellspacing="1" width="100%" >
                <tr class="itemTitle" >
		            <td colspan="2" style="height: 25px">
		                <li>
                            <cc1:CustLabel ID="lblTitle" runat="server" CurAlign="left" CurSymbol="£"  IsColon="False"  ShowID="04_02020400_001" ></cc1:CustLabel></li>
		            </td>
	            </tr>
                <tr class="trOdd">
                    <td style="text-align: right;width:15%; height: 25px;">
                        <cc1:CustLabel ID="lblUserID" runat="server" ShowID="04_02020400_002" CurAlign="left" CurSymbol="£" FractionalDigit="2" IsColon="False" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" StickHeight="False"></cc1:CustLabel>：                    
                    </td>
                ...
                <tr class="trEven">
                    <td align="right" style="width: 15%;height:50px;">
                        <cc1:CustLabel ID="lblSVType" runat="server" CurAlign="left"  ShowID="04_02020400_003" CurSymbol="£" FractionalDigit="2" IsColon="False" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" StickHeight="False"></cc1:CustLabel>：</td>
                ...
                <tr class="itemTitle" align="center" >
                    <td colspan="2" style="height: 25px">
                        <cc1:CustButton  ID="btnQuery" runat="server"  CssClass="smallButton" OnClick="btnQuery_Click" ShowID="04_02020400_021" />&nbsp;&nbsp;
                    </td>
               </tr>
                <tr>
                    <td colspan="2">
                        <cc1:CustGridView ID="gvpbPay_SV" runat="server" AllowSorting="True"  PagerID="gpList"
                        Width="100%"  BorderWidth="0px" CellPadding="0" CellSpacing="1" BorderStyle="Solid" PagerVisible="True" OnRowDataBound="grvPay_SV_RowDataBound" OnRowEditing="grvPay_SV_RowEditing" >
