<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P040301040001.aspx.cs" Inherits="Page_P040301040001" %>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="1">
                    ...
                    <tr class="trOdd">
                        <td align="right" style="width: 20%">
                            <cc1:CustLabel ID="lblID" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_03010300_003" StickHeight="False"></cc1:CustLabel></td>
                        <td style="width: 80%">
                    ...
                    <tr align="center" class="itemTitle">
                        <td colspan="2">
                            <cc1:CustButton ID="btnSearch" runat="server" class="smallButton" Style="width: 50px;" OnClick="btnSearch_Click" ShowID="04_03010300_006"/>&nbsp;&nbsp;
                            <cc1:CustButton ID="btnClear" runat="server" class="smallButton" Style="width: 50px;" OnClick="btnClear_Click"  ShowID="04_03010300_007"/>
                        </td>
                    </tr>
                </table>
