...
public partial class Page_P040302060001 : PageBase
{
    #region Event
    /// <summary>
    /// 畫面裝載時的處理
    ...
    {
        Page.Title = BaseHelper.GetShowText("04_03020600_000");
        if (!Page.IsPostBack)
        {
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        {
            MessageHelper.ShowMessage(this.UpdatePanel1, "04_03020600_006");
            return;
        }
        //* 郵寄方式
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (BRReport.Report0302060002(strMailDay, strMailType, strLogonUserName, ref strMsgID, ref dstResult, "P"))
            {
            ...
            if (dstResult != null)
            {
                ...
                if (!BR_Excel_File.CreateExcelFile_Report0302060002(dstResult, strMailDay, strLogonUserName, ref strServerPathFile, ref strMsgID))
                {
                ...
                string strFileName = "開立ML結清證明-大宗掛號存根聯" + strYYYYMMDD + ".xls";
    ...
    private void BindGridView(bool blShowUser)
    {
        ...
        try
        {
            if (!BRSet_Pay_Certify.SearchResult_03020600(this.ViewState["MailDay"].ToString(),
            ...
            //* 查詢成功
            jsBuilder.RegScript(this.Page, BaseHelper.ClientMsgShow("04_03020600_003"));
        }
        catch (Exception exp)
        {
            Logging.Log(exp, LogLayer.UI);
            jsBuilder.RegScript(this.Page, BaseHelper.ClientMsgShow("04_03020600_002"));
        }
    }
    /// <summary>
    /// 顯示窗體文字
    ...
    {
        //* 郵寄方式
        this.radlMailType.Items[0].Text = BaseHelper.GetShowText("04_03020600_004");
        this.radlMailType.Items[1].Text = BaseHelper.GetShowText("04_03020600_005");
        this.radlMailType.Items[2].Text = BaseHelper.GetShowText("04_03020600_006");

        //* 設置查詢結果GridView的列頭標題
        this.gvpbSetPayCertify.Columns[0].HeaderText = BaseHelper.GetShowText("04_03020600_010");
        this.gvpbSetPayCertify.Columns[1].HeaderText = BaseHelper.GetShowText("04_03020600_011");
        this.gvpbSetPayCertify.Columns[2].HeaderText = BaseHelper.GetShowText("04_03020600_012");
        this.gvpbSetPayCertify.Columns[3].HeaderText = BaseHelper.GetShowText("04_03020600_013");
        this.gvpbSetPayCertify.Columns[4].HeaderText = BaseHelper.GetShowText("04_03020600_014");
        this.gvpbSetPayCertify.Columns[5].HeaderText = BaseHelper.GetShowText("04_03020600_015");
        //* 設置一頁顯示最大筆數
