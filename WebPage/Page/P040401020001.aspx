<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P040401020001.aspx.cs" Inherits="Page_P040401020001" %>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="1">
                    ...
                    <tr class="trOdd">
                        <td align="right" style="width: 20%">
                            <cc1:CustLabel ID="lblUserID" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_04010200_003" StickHeight="False"></cc1:CustLabel></td>
                        <td style="width: 80%">
                    ...
                    <tr class="trEven">
                        <td align="right" style="width: 20%">
                            <cc1:CustLabel ID="lblUserName" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_04010200_004" StickHeight="False"></cc1:CustLabel></td>
                        <td style="width: 80%">
                    ...
                    <tr align="center" class="itemTitle">
                        <td colspan="2">
                            <cc1:CustButton ID="btnSearch" runat="server" class="smallButton" Style="width: 50px;" OnClick="btnSearch_Click" ShowID="04_04010200_006"/>&nbsp;&nbsp;
                            <cc1:CustButton ID="btnClear" runat="server" class="smallButton" Style="width: 50px;" OnClick="btnClear_Click"  ShowID="04_04010200_007"/>
                        </td>
                    </tr>
                </table>
                            ...
                            <cc1:CustGridView ID="grvSetPayCertify" runat="server" AllowSorting="True" PagerID="gpList"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <itemtemplate>
<cc1:CustLinkButton id="lkbDetail" runat="server" CommandName='<%# DataBinder.Eval(Container.DataItem,"SerialNo")%>' __designer:wfdid="w1" OnClick="lkbDetail_Click"><%# BaseHelper.GetShowText("04_04010200_008")%></cc1:CustLinkButton> 
</itemtemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </cc1:CustGridView>
