<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P040302060001.aspx.cs" Inherits="Page_P040302060001" %>
                        ...
                        <td colspan="2">
                            <li>
                                <cc1:CustLabel ID="lblTitle" runat="server" CurAlign="left" CurSymbol="&#163;" FractionalDigit="2"
                                    IsColon="False" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="04_03020600_001" StickHeight="False"></cc1:CustLabel></b></li>
                        </td>
                    </tr>
                    <tr class="trOdd">
                        <td align="right" style="width: 20%">
                            <cc1:CustLabel ID="lblMailDay" runat="server" CurAlign="left" CurSymbol="&#163;"
                                ...
                                NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_03020600_002"
                                StickHeight="False"></cc1:CustLabel></td>
                        <td style="width: 80%">
                            <cc1:DatePicker ID="dtpMailDay" Text="" MaxLength="10" runat="server"></cc1:DatePicker>
                        </td>
                    </tr>
                    <tr class="trEven">
                        <td align="right" style="width: 20%">
                            <cc1:CustLabel ID="lblMailType" runat="server" CurAlign="left" CurSymbol="&#163;"
                                FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_03020600_003"
                                StickHeight="False"></cc1:CustLabel></td>
                        <td style="width: 80%">
                            <cc1:CustRadioButtonList ID="radlMailType" runat="server" RepeatDirection="Horizontal">
