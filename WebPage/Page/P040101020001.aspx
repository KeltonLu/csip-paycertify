<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P040101020001.aspx.cs" Inherits="Page_P040101020001" %>
                    ...
                    <tr class="trOdd">
                        <td align="right" style="width: 15%">
                            <cc1:CustLabel ID="lblUserId" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                ...
                                SetBreak="False" SetOmit="False" ShowID="04_01010200_002" StickHeight="False"></cc1:CustLabel></td>
                    ...
                    <tr class="trEven">
                        <td align="right" style="width: 15%">
                            <cc1:CustLabel ID="lblType" runat="server" FractionalDigit="2" IsColon="True" IsCurrency="False"
                                ...
                                StickHeight="False" ShowID="04_01010200_003" CurAlign="left" CurSymbol="£"></cc1:CustLabel>
                        </td>
                        <td style="width: 85%">
                    ...
                    <tr>
                        <td align="center" class="itemTitle" colspan="2">
                            <cc1:CustButton ID="btnSearch" runat="server" class="smallButton" Style="width: 50px;"
                                ShowID="04_01010200_004" OnClick="btnSearch_Click" />
                        </td>
                    </tr>
                    <tr>
                            ...
                            <cc1:CustGridView ID="grvPaySV" runat="server" AllowSorting="True" PagerID="gpList"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <headerstyle width="4%" />
                                        <itemtemplate>
                                        <cc1:CustLinkButton id="lkbDetail" runat="server" CommandName='<%# DataBinder.Eval(Container.DataItem,"SerialNo")%>' OnClick="lkbDetail_Click"><%# BaseHelper.GetShowText("04_01010200_015")%></cc1:CustLinkButton> 
                                        </itemtemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </cc1:CustGridView>
