<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P040302020001.aspx.cs" Inherits="Page_P040302020001" %>
                        ...
                        <td colspan="2">
                            <li>
                                <cc1:CustLabel ID="lblTitle" runat="server" CurAlign="left" CurSymbol="&#163;" FractionalDigit="2"
                                    IsColon="False" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="04_03020200_001" StickHeight="False"></cc1:CustLabel></b></li>
                        </td>
                    </tr>
                    <tr class="trOdd">
                        <td align="right" style="width: 20%">
                            <cc1:CustLabel ID="lblCertifyNo" runat="server" CurAlign="left" CurSymbol="&#163;"
                                ...
                                NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_03020200_002"
                    ...
                    <tr class="trEven">
                        <td align="right" style="width: 20%">
                            <cc1:CustLabel ID="lblID_No" runat="server" CurAlign="left" CurSymbol="&#163;" FractionalDigit="2"
                                ...
                                SetBreak="False" SetOmit="False" ShowID="04_03020200_003" StickHeight="False"></cc1:CustLabel></td>
                        <td style="width: 80%">
                            <cc1:CustTextBox ID="txtID_No" Style="ime-mode: disabled; text-align: left" runat="server"
                                MaxLength="11"></cc1:CustTextBox>&nbsp;&nbsp;&nbsp;&nbsp;
                            <cc1:CustTextBox ID="txtID_Name" runat="server"  MaxLength="20" Enabled="False" ></cc1:CustTextBox></td>
                    </tr>
                    <tr class="trOdd">
                        <td align="right" style="width: 20%">
                            <cc1:CustLabel ID="lblSelfGetDate" runat="server" CurAlign="left" CurSymbol="&#163;"
                                FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_03020200_004"
                                StickHeight="False"></cc1:CustLabel></td>
                        <td style="width: 80%">
                    ...
                    <tr class="trEven">
                        <td align="right" style="width: 20%">
                            <cc1:CustLabel ID="lblCardNo" runat="server" CurAlign="left" CurSymbol="&#163;" FractionalDigit="2"
                                IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                SetBreak="False" SetOmit="False" ShowID="04_03020200_005" StickHeight="False"></cc1:CustLabel></td>
                        <td style="width: 80%">
                    ...
                    <tr align="center" class="itemTitle">
                        <td colspan="2">
                            <cc1:CustButton ID="btnSearch" runat="server" class="smallButton" Style="width: 50px;"
                                OnClick="btnSearch_Click" ShowID="04_03020200_006" />&nbsp;&nbsp;
                            <cc1:CustButton ID="btnClear" runat="server" class="smallButton" Style="width: 50px;"
                                OnClick="btnClear_Click" ShowID="04_03020200_007" />&nbsp;&nbsp;
                            <cc1:CustButton ID="btnPrintTotal" runat="server" class="smallButton" Style="width: 100px;"
                                OnClick="btnPrintTotal_Click" ShowID="04_03020200_008" />&nbsp;&nbsp;
                            <cc1:CustButton ID="btnPrintDetail" runat="server" class="smallButton" Style="width: 80px;"
                                OnClick="btnPrintDetail_Click" ShowID="04_03020200_009" />
                        </td>
                    </tr>
                </table>
