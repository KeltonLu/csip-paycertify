<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P040401010001.aspx.cs" Inherits="Page_P040401010001" %>

<%@ Register Assembly="Framework.WebControls" Namespace="Framework.WebControls" TagPrefix="cc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<%--調整Alert語法by Ares Stanley 20220122--%>
   ...
   .btnHiden
    ...
    <script language="javascript" type="text/javascript">	
        ...
        function selectedGetType()
        {
            ...
            else//* 自取時‘郵寄方式’和‘掛號號碼’兩個欄位不可以輸入
            { 
        ...
        function CheckConditionSave(){
            ...
            //* 代償人姓名必須輸入
            if (document.getElementById("txtPayName").value.Trim() == "")
            {
                if(strMsg==""){
                    document.getElementById("txtPayName").focus();
                }
                strMsg = strMsg + "代償人姓名不可為空白\n\n";
            }

            //* 代償日期必須輸入
            if (document.getElementById("dpPayDay_foo").value.Trim() == "")
            {
                if(strMsg==""){
                    document.getElementById("dpPayDay_foo").focus();
                }
                strMsg = strMsg + "代償日期不可為空白\n\n";
            }

            //* 代償金額必須輸入
            if (document.getElementById("txtPay").value.Trim() == "")
            {
                if(strMsg==""){
                    document.getElementById("txtPay").focus();
                }
                strMsg = strMsg + "代償金額不可為空白\n\n";
            }
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
            <ContentTemplate>
                <table width="100%" border="0" cellpadding="0" cellspacing="1">
                        ...
                        <td colspan="4">
                            <li>
                                <cc1:CustLabel ID="lblTitle" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="False" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="04_04010100_001" StickHeight="False"></cc1:CustLabel></li>
                        </td>
                    </tr>
                    <tr class="trOdd">
                        <td align="right" style="width: 20%">
                            <cc1:CustLabel ID="lblUserIDQuery" runat="server" CurAlign="left" CurSymbol="£"
                                ...
                                NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_04010100_002"
                    ...
                    <tr class="itemTitle">
                        <td colspan="4" align="center">
                            <cc1:CustButton ID="btnSearch" class="smallButton" runat="server" ShowID="04_04010100_021"
                                Style="width: 50px" DisabledWhenSubmit="False" OnClick="btnSearch_Click" OnClientClick="return checkInputText();"></cc1:CustButton>
                        </td>
                    </tr>
                </table>
                <table width="100%" border="0" cellpadding="0" cellspacing="1" id="TableDetail" style="display: none">
                    <tr class="trOdd">
                        ...
                        <td align="right" style="width: 15%; height: 25px;">
                            <cc1:CustLabel ID="lblUserName" runat="server" CurAlign="left" CurSymbol="£"
                                FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_04010100_003"
                                StickHeight="False"></cc1:CustLabel></td>
                        <td style="width: 35%; height: 25px;">
                    ...
                    <tr class="trEven">
                        <td align="right" style="width: 15%">
                            <cc1:CustLabel ID="lblCardNo" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                ...
                                SetBreak="False" SetOmit="False" ShowID="04_04010100_004" StickHeight="False"></cc1:CustLabel></td>
                        <td style="width: 35%">
                        ...
                        <td align="right" style="width: 15%">
                            <cc1:CustLabel ID="lblZip" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                SetBreak="False" SetOmit="False" ShowID="04_04010100_005" StickHeight="False"></cc1:CustLabel></td>
                        <td style="width: 35%">
                    ...
                    <tr class="trOdd">
                        <td align="right" style="width: 20%">
                            <cc1:CustLabel ID="lblAdd1" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                SetBreak="False" SetOmit="False" ShowID="04_04010100_006" StickHeight="False"></cc1:CustLabel></td>
                        <td colspan="3" style="width: 80%">
                    ...
                    <tr class="trEven">
                        <td align="right" style="width: 20%">
                            <cc1:CustLabel ID="lblAdd2" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                SetBreak="False" SetOmit="False" ShowID="04_04010100_007" StickHeight="False"></cc1:CustLabel></td>
                        <td colspan="3" style="width: 80%">
                    ...
                    <tr class="trOdd">
                        <td align="right" style="width: 20%">
                            <cc1:CustLabel ID="lblAdd3" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                SetBreak="False" SetOmit="False" ShowID="04_04010100_008" StickHeight="False"></cc1:CustLabel></td>
                        <td colspan="3" style="width: 80%">
                            <cc1:CustTextBox ID="txtAdd3" runat="server" MaxLength="50" Style="text-align: left" Width="448px"></cc1:CustTextBox></td>
                    </tr>
                    <tr class="trEven">
                        <td align="right" style="width: 15%">
                            <cc1:CustLabel ID="lblPayName" runat="server" CurAlign="left" CurSymbol="£"
                                FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_04010100_009"
                                StickHeight="False"></cc1:CustLabel></td>
                        <td style="width: 35%">
                            <cc1:CustTextBox ID="txtPayName" runat="server" MaxLength="10" Style="text-align: left"></cc1:CustTextBox></td>
                        <td align="right" style="width: 15%">
                            <cc1:CustLabel ID="lblPayDay" runat="server" CurAlign="left" CurSymbol="£"
                                FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_04010100_010"
                                StickHeight="False"></cc1:CustLabel></td>
                        <td style="width: 35%">
                            <cc1:DatePicker ID="dpPayDay" runat="server" MaxLength="10" Text="" Width="150"></cc1:DatePicker>
                        </td>
                    </tr>
                    <tr class="trOdd">
                        <td align="right" style="width: 15%">
                            <cc1:CustLabel ID="lblPay" runat="server" CurAlign="left" CurSymbol="£"
                                FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_04010100_011"
                                StickHeight="False"></cc1:CustLabel></td>
                        <td style="width: 35%" colspan="3">
                            <cc1:CustTextBox  id="txtPay" runat="server" MaxLength="9" InputType="Int"></cc1:CustTextBox>
                        </td>
                    </tr>
                    <tr class="trEven">
                        <td align="right" style="width: 15%">
                            <cc1:CustLabel ID="lblRecvName" runat="server" CurAlign="left" CurSymbol="£"
                                FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_04010100_012"
                                StickHeight="False"></cc1:CustLabel></td>
                        <td style="width: 35%">
                        ...
                        <td align="right" style="width: 15%">
                            <cc1:CustLabel ID="lblGetType" runat="server" CurAlign="left" CurSymbol="£"
                                FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_04010100_013"
                                StickHeight="False"></cc1:CustLabel></td>
                        <td style="width: 35%">
                    ...
                    <tr class="trOdd">
                        <td align="right" style="width: 15%">
                            <cc1:CustLabel ID="lblLoanDay" runat="server" CurAlign="left" CurSymbol="£"
                                FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_04010100_016"
                                StickHeight="False"></cc1:CustLabel></td>
                        <td style="width: 35%">
                            <cc1:DatePicker ID="dpLoanDay" Text="" MaxLength="10" runat="server" Width="150"></cc1:DatePicker>
                        </td>
                        <td align="right" style="width: 15%">
                            <cc1:CustLabel ID="lblMailDay" runat="server" CurAlign="left" CurSymbol="£"
                                FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_04010100_017"
                                StickHeight="False"></cc1:CustLabel></td>
                        <td style="width: 35%">
                            <cc1:DatePicker ID="dpMailDay" Text="" MaxLength="10" runat="server" Width="150"></cc1:DatePicker>
                        </td>
                    </tr>
                    <tr class="trEven">
                        <td align="right" style="width: 15%">
                            <cc1:CustLabel ID="lblMailType" runat="server" CurAlign="left" CurSymbol="£"
                                FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_04010100_018"
                                StickHeight="False"></cc1:CustLabel></td>
                        <td style="width: 35%">
                        ...
                        <td align="right" style="width: 15%">
                            <cc1:CustLabel ID="lblMailNo" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                SetBreak="False" SetOmit="False" ShowID="04_04010100_019" StickHeight="False"></cc1:CustLabel></td>
                        <td style="width: 35%">
                    ...
                    <tr class="trOdd">
                        <td align="right" style="width: 20%; height: 34px;">
                            <cc1:CustLabel ID="lblNote" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                SetBreak="False" SetOmit="False" ShowID="04_04010100_020" StickHeight="False"></cc1:CustLabel></td>
                    ...
                    <tr align="center" class="itemTitle">
                        <td colspan="4">
                            <cc1:CustButton ID="btnSave" runat="server" class="smallButton" Style="width: 50px;"
                                ShowID="04_04010100_022" DisabledWhenSubmit="False" OnClick="btnSave_Click" OnClientClick="return CheckConditionSave();"/>&nbsp;&nbsp;
                            <cc1:CustButton ID="btnClear" runat="server" class="smallButton" Style="width: 50px;"
                                ShowID="04_04010100_023" OnClick="btnClear_Click" /></td>
                    </tr>
                </table>
