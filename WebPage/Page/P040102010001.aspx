<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P040102010001.aspx.cs" Inherits="Page_P040102010001" %>
...
<asp:ScriptManager ID="ScriptManager1" EnablePageMethods="True" runat="server">
    ...
    <tr class="itemTitle" >
					<td colspan="2">
					<li>
                        <cc1:CustLabel ID="lblTitle" runat="server" CurAlign="left" CurSymbol="&#163;" FractionalDigit="2" IsColon="False" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_01020100_001" StickHeight="False"></cc1:CustLabel></li></td>
				</tr>
         
   <tr class="trOdd">
        <td style="text-align: right;width:15%">
            <cc1:CustLabel ID="lblDate" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="04_01020100_002" StickHeight="False"></cc1:CustLabel> </td>
...
<tr class="itemTitle" align="center" >
    <td colspan="2">
        <cc1:CustButton ID="btnSearch" runat="server" CssClass="smallButton" onclick="btnSearch_Click" ShowID="04_01020100_004"/>
        <cc1:CustButton ID="btnOK" runat="server" CssClass="smallButton" onclick="btnOK_Click" ShowID="04_01020100_003"/></td></tr>
    </table>
