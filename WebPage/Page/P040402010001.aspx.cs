...
public partial class Page_P040402010001 : PageBase
{
    /// Session變數集合
    ...
    {
        Page.Title = BaseHelper.GetShowText("04_04020100_000");
        if (!Page.IsPostBack)
        {
    ...
    protected void gvpbSetPayCertify_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            {
                e.Row.Cells[5].Text = BaseHelper.GetShowText("04_04020100_019");
            }
    ...
    private void BindGridView()
    {
        ...
        try
        {
            if (!BRSet_Pay_Certify.SearchResult_04020100(this.ViewState["StartSerialNo"].ToString(),
            ...
            //* 查詢成功
            jsBuilder.RegScript(this.Page, BaseHelper.ClientMsgShow("04_04020100_008"));
        }
        catch (Exception exp)
        {
            Logging.Log(exp, LogLayer.UI);
            jsBuilder.RegScript(this.Page, BaseHelper.ClientMsgShow("04_04020100_007"));
        }
    }
    /// <summary>
    /// 顯示窗體文字
    ...
    {
        //* 設置查詢結果GridView的列頭標題
        this.gvpbSetPayCertify.Columns[0].HeaderText = BaseHelper.GetShowText("04_04020100_008");
        this.gvpbSetPayCertify.Columns[1].HeaderText = BaseHelper.GetShowText("04_04020100_009");
        this.gvpbSetPayCertify.Columns[2].HeaderText = BaseHelper.GetShowText("04_04020100_010");
        this.gvpbSetPayCertify.Columns[3].HeaderText = BaseHelper.GetShowText("04_04020100_011");
        this.gvpbSetPayCertify.Columns[4].HeaderText = BaseHelper.GetShowText("04_04020100_012");
        this.gvpbSetPayCertify.Columns[5].HeaderText = BaseHelper.GetShowText("04_04020100_013");
        this.gvpbSetPayCertify.Columns[6].HeaderText = BaseHelper.GetShowText("04_04020100_014");
        this.gvpbSetPayCertify.Columns[7].HeaderText = BaseHelper.GetShowText("04_04020100_015");
        this.gvpbSetPayCertify.Columns[8].HeaderText = BaseHelper.GetShowText("04_04020100_016");
        this.gvpbSetPayCertify.Columns[9].HeaderText = BaseHelper.GetShowText("04_04020100_017");
        this.gvpbSetPayCertify.Columns[10].HeaderText = BaseHelper.GetShowText("04_04020100_018");
        //* 設置一頁顯示最大筆數
