...
";
        ...
        public static bool SearchResult(EntityPay_SV eyPay_SV, int iPageIndex, int iPageSize, ref int iTotalCount, ref string strMsgID, ref DataTable dtblPay_SV)
        {
            try
            {
        ...
        /// <returns></returns>
        public static bool SearchResult(string strUserID, bool blIsKeyIn, string strBeforeDate, string strEndDate, int intPageIndex, int intPageSize, ref int intTotalCount, ref string strMsgID, ref  DataTable dtblResult)
        {
            try
            {
                SqlCommand sqlcmdSearchResult = new SqlCommand();
